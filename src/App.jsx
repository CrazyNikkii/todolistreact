...
function App() {
  ...
  const fetchBooks = () => {
    fetch(
      "https://bookstore-b0d54-default-rtdb.europe-west1.firebasedatabase.app/books/.json",
    )
  ...
  const deleteBook = (id) => {
    fetch(
      `https://bookstore-b0d54-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
      {
        method: "DELETE",
      },
    )
